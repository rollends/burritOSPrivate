...
{
#if defined(KERNEL_PERF) && defined(KERNEL_PERF_VERBOSE)
    ...
    U32 i;
    printf(stdio,"\tTaskId\tTsk %%\tKrnl %%\tTtl %%\tTsk us\t\tKrnl us\t\tTtl us\r\n");
    for (i = 0; i <= 8; i++)
    {
        if (i == 0)
        {
        ...
        printf(stdio, "\t%b\t%2d.%2d\t%2d.%2d\t%2d.%2d\t%9n\t%9n\t%9n\r\n", i,
                                                           up / 100, up % 100,
                                                           kp / 100, kp % 100,
                                                           tp / 100, tp % 100,
                                                           uu,
    ...
    for(;;)
    {
        ...
        printf( stdio, 
                "\033[s\033[2;1HIdling for %2d%%\033[u",
